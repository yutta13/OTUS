...
public class HomeWork3New {
    public static void main(String[] args) {
        ...
        findMax(new int[][] {{1, 2, 3, 5, 66}, {118, 12,13, 14, 16}, {21, 22, 72, 25, 26}, {31, 32, 33, 35, 36}, {41, 42, 84, 45, 46}});
        sumSecondLineElements(new int[][]{{1, 2, 3, 5, 66}, {31, 32, 33, 35, 36}, {41, 42, 84, 45, 46}});
