...
public class Mainapp {
    public static void main(String[] args) {
        ...
        User[] user1 = new User{"22", "Mikovich", "Kashtanov", "mail@mail.ru",39};
...
//        User[] user10 = new User("Nik10", "Mikovich", "Kashtanov", "mail@mail.ru",40  );
        User[][] usersArray = {{user1[user1.length]},{user2[user2.length]}};

        System.out.println(Arrays.deepToString(user1));
